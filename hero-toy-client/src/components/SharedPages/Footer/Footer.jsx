...
const Footer = () => {
    return (
        <footer className="pt-10 px-10 lg:px-24 bg-[#0a0a0a] text-white">
            <div className="footer">
                <div>
                    ...
                    <p>Get your favorite <br />action hero toy from HeroToy!</p>
                </div>
                <div>
            ...
            <p className="mt-5 pb-3 text-sm text-center">Copyright © 2023 - All right reserved</p>
        </footer>
    );
};
